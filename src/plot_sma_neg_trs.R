...
outfile <- commandArgs(trailingOnly=TRUE)[10]

# Loading
source_all_exp <- read.csv(infile1, header=TRUE)
source_exp <- read.csv(infile2, header=FALSE)
target_exp <- read.csv(infile3, header=FALSE)
source_celltype <- read.csv(infile4, header=TRUE)
target_celltype <- read.csv(infile5, header=TRUE)
source_x_coordinate <- unlist(read.csv(infile6, header=FALSE))
target_x_coordinate <- unlist(read.csv(infile7, header=FALSE))
source_y_coordinate <- unlist(read.csv(infile8, header=FALSE))
target_y_coordinate <- unlist(read.csv(infile9, header=FALSE))
...
outfile9 = paste0(outdir, "source_celltype.png")
outfile10 = paste0(outdir, "target_celltype.png")
...
png(outfile10, width=1000, height=1000, bg="transparent")
